...
var getAllNews = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var news, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var getLimitNews = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var limit, options, news, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                limit = parseInt(_req.params.limit);
                options = {};
                if (!isNaN(limit) && limit > 0) {
                    options = { limit: limit };
                }
                return [4 /*yield*/, model_1.default.findAll(__assign({ include: [
                            {
                                model: model_2.default,
                            },
                        ] }, options))];
...
var getNewBySlug = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var slug, news, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
